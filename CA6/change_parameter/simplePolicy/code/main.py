...
from snake_4 import Snake_4
from snake_3 import Snake_3
...
def main():
    ...
    snake_1 = Snake_3((255, 0, 0), (15, 15), SNAKE_1_Q_TABLE) # simple
    snake_2 = Snake_4((255, 255, 0), (5, 5), SNAKE_2_Q_TABLE)
    snake_1.addCube()
    snake_2.addCube()
